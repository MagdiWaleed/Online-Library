...
async function getBookData() {
       ...
       function goToSingleBook(singleBookDataindex){
            ...
            if(bookList[singleBookDataindex].user_id != null){
...
async function getTrendingBooksList() {
       ...
       for (const book of bookData) {
             ...
             document.getElementById('bookshelvesT').innerHTML = bookCardsList; // Update the container with the generated HTML
       }

async function getLatestBooksList() {
       const bookData = await getBookData();
       let bookCardsList = '';
      ...
      document.getElementById('bookshelvesL').innerHTML = bookCardsList; // Update the container with the generated HTML
}
